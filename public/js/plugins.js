...
$(function(){
    ...
    $('.collapse').on('shown.bs.collapse', function () {
        //console.log(': ', $(this).prev().find('a.accordion-toggle > span.label').attr('class'));
        $(this).prev().find('a.accordion-toggle > span.label').addClass('hidden');
    }).on('hidden.bs.collapse', function () {
        $(this).prev().find('a.accordion-toggle > span.label').removeClass('hidden');
    })
});